...
export class TemaService {
  ...
  postTema(tema: Tema): Observable<Tema> {
    return this.http.post<Tema>('https://marlonblog.herokuapp.com/tema', tema, this.token)
  }

  putTema(tema : Tema): Observable<Tema> {
    return this.http.put<Tema>('https://marlonblog.herokuapp.com/tema', tema , this.token)
  }

  deleteTema(id: number) {
    return this.http.delete(`https://marlonblog.herokuapp.com/tema/${id}`, this.token)
  }
